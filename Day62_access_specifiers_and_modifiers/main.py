...
class Employee:
    ...
    def __init__(self):         #Private (__ > double underscore daalne se)
        self.__name = "Mittesh"
        a = Employee()   
        print(a.__name) # > This (name variable) cannot be accessed directly but can be accessed indirectly       
        print(a._Employee__name)# aise hum us private class variable ko access kar payege by using (_classname__variablename)

        # (_Employee__name) > ise hum name mangling kehte hai python me
